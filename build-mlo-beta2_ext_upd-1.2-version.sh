...
\cp -r ../my_files/luci-app-atinout-mod-main/luci-app-atinout-mod/ feeds/luci/applications
\cp -r ../my_files/luci-app-atinout-mod-main/atinout/ feeds/packages/net/atinout
